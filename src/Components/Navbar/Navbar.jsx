  ...
  return (
    <div className='h-[101px] w-[1440px] bg-gray-100'>
        <div className='flex flex-row w-[1236px] h-[55px] relative top-[23px] left-[104px] gap-[119px]'>
            ...
            <button onClick={()=>handleSignUp()} className='flex flex-row w-[259px] h-[55px] text-white items-center justify-center rounded-[90px] bg-black p-3 gap-3 bg-gradient-to-r from-purple-500 via-purple-700 to-purple-900'>
